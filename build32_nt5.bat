...
set CCOPT=/DVTOY_NT5 /I./src /I./src/fat_io_lib /GS /GL /analyze- /W3 /Gy /Zc:wchar_t /Zi /Gm- /O2 /fp:precise /DFATFS_INC_FORMAT_SUPPORT=0 /DVTOY_BIT=32 /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_LIB" /D "_UNICODE" /D "UNICODE" /errorReport:prompt /WX- /Zc:forScope /Gd /Oy- /Oi /MT /EHsc /nologo
